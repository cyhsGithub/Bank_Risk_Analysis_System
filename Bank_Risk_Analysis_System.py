...
# using default penalty = 'l2' and C = 1.0
...
# svm_model, test_auc = clf.svm_build()
# print('svm model test_auc, using GridSearch to choose the best parameters "kernel" and C: ', test_auc)
